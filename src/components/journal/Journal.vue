        ...
        <v-dialog v-if="form2.open" persistent v-model="form2.open" max-width="500px">
            <v-card>
                <v-form v-model="form2.valid" ref="form2">
                    <v-card-title>
                        <span class="headline">Информация о занятии</span>
                    </v-card-title>
                    <v-card-text>
                        <v-container grid-list-md>
                            <v-layout wrap>
                                    ...
                                    >
                                        <template v-slot:activator="{ on }">
                                            <v-text-field
                                                    ...
                                                    label="Добавьте дату проведения"
                                                    prepend-icon="event"
                                                    readonly
                                                    :rules="rules.name"
                                                    v-on="on"
    ...
    export default {
        ...
        data: () => ({
            ...
            rules: {
                ...
                phone: [
                    v => v && v.length && v.length === 10 || "Введите корректный номер"
                ]
            },
        }),
